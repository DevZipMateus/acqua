...
const projects = [
  {
    ...
    image: "https://images.unsplash.com/photo-1558618666-fbd19c4cd14b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
              ...
              <div className="relative h-64 overflow-hidden bg-construction-100">
                ...
                <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-40 transition-all duration-300 flex items-center justify-center">
                  <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <button className="w-12 h-12 bg-white rounded-full flex items-center justify-center text-blue-600 hover:bg-blue-50 transition-colors">
